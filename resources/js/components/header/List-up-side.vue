<template>
    ...
    <div class="collapse navbar-collapse">
        ...
        <ul class="navbar-nav mr-auto tracking-widest rol">
            ...
            <b-sidebar
                ...
                <div v-if="admin">
                    ...
                    <b-card
                        ...
                        <b-card-text>
                            <span style="color: green;"><b-col></b-col>Время доставки заказов</span>
                        </b-card-text>
                        ...
                        <b-card-text v-if="set_time_use">
                            <b-alert show variant="warning" v-if="can_after_loading"><img class="avatar_1"
                                                                                          src="/images/icon-promouter/success.png">
                                Время записанно
                            </b-alert>
                        </b-card-text>
                    ...
                    <b-card
                        ...
                        <b-card-text v-if="ifSend_login_or_password">
                            <b-alert show v-if="!set_new_value">
                                <b-col></b-col>
            ...
            <div v-if="ifThisRouteKurer">
                <h4  class="mt-2 ml-5">Всего курьеров
                    <b-badge variant="danger">{{sumKurer}}</b-badge>
                </h4>
            </div>
        ...
        <spav v-if="ifUpdateSpinner" class=" ml-1"><img src="/images/loading.svg" class="width pl-2 pr-2"> обновление
            ...
        </spav>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li v-if="ifThisRouteZakaz"><a :href="'/chekPrint/' + date " class="nav-link text-lg" v-if="date"><img
                src="/images/icon-header/printer.png" alt="print"></a><a href="/chekPrint_Data_Now "
                                                                         class="nav-link text-lg" v-else><img
...
export default {
    ...
    computed: {
        ...mapGetters(['AllKurers', 'AllZakazFind', 'if_empty_zakaz', 'sumKurer']),
    ...
    methods: {
        ...
        addNewUser_login_password() {
            ...
            if (this.set_login) {
                ...
                axios.post(`api/v1/edit_and_send_superadmin_login_or_password`, {
                    field_id: '1',
                    field_name: 'email',
                    field_value: this.set_login
                })
            } else {
                axios.post(`api/v1/edit_and_send_superadmin_login_or_password`, {
                    field_id: '1',
                    field_name: 'password',
                    field_value: this.set_password
                })
            }
